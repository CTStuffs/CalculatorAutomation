...
class CalculatorTests < MiniTest::Test
    ...
    INT_MAX = 9999999999
    INT_MIN = -999999999
    URL_MAIN = "https://testsheepnz.github.io/BasicCalculator.html"

    def setup
        @browser = Selenium::WebDriver.for :firefox
        @browser.manage.timeouts.implicit_wait = 5
        @calculator = CalculatorPage.new(@browser, URL_MAIN)
        @calculator.visit
    ...
    def perform_operation(op, val1, val2, result)
        ...
        assert_equal(result.to_s, answer)  
    end
   ...
   #boundary limit test
    ...
    def test_addition_3  
        ...
        perform_operation("Add", 3.1415926, 441421.356, "441424.4975926")
    end

     # negative number addition
    def test_addition_4
       
        perform_operation("Add", -123456789 , -987654321, "-1111111110")
    end

    # ordinary subtraction
    def test_subtraction_1
       
        perform_operation("Subtract", 123456, 54321,"69135")
    end
    ...
    def test_subtract_3
        ...
        perform_operation("Subtract", INT_MAX, INT_MIN, "10999999998")
    end

    # boundary value cases, also a negative num subtracting a positive one
    def test_subtract_4
       
        perform_operation("Subtract", INT_MIN, INT_MAX, "-10999999998")
    end

    def test_subtract_5
       
        perform_operation("Subtract", 2.14532159, 3.12353426, "-0.97821267")
    end
